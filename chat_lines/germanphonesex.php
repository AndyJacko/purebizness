...
$query_RSCats = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 7 ORDER BY cat_name ASC";
...
if (isset($_GET["tbl_id"])) {
  ...
  mysql_select_db($database_Wisdom_Mcr, $Wisdom_Mcr);
  $query_RSCatName = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 7 AND tbl_id = ".$_GET["tbl_id"];
...
<?php } else {?>
<meta name="description" content="German Phone Sex | German Chat Lines | Adult Sex Lines">
<meta name="keywords" content="German Phone Sex | German Chat Lines | Adult Sex Lines">
<title>German Phone Sex | German Chat Lines | Adult Sex Lines</title>
<?php } ?>
<!-- InstanceEndEditable -->
