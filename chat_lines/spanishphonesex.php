...
$query_RSCats = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 8 ORDER BY cat_name ASC";
...
if (isset($_GET["tbl_id"])) {
  ...
  mysql_select_db($database_Wisdom_Mcr, $Wisdom_Mcr);
  $query_RSCatName = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 8 AND tbl_id = ".$_GET["tbl_id"];
...
<?php } else {?>
<meta name="description" content="Spanish Phone Sex | Spanish Chat Lines | Adult Sex Lines">
<meta name="keywords" content="Spanish Phone Sex | Spanish Chat Lines | Adult Sex Lines">
<title>Spanish Phone Sex | Spanish Chat Lines | Adult Sex Lines</title>
<?php } ?>
<!-- InstanceEndEditable -->
