...
$query_RSCats = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 3 ORDER BY cat_name ASC";
...
if (isset($_GET["tbl_id"])) {
  ...
  mysql_select_db($database_Wisdom_Mcr, $Wisdom_Mcr);
  $query_RSCatName = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 3 AND tbl_id = ".$_GET["tbl_id"];
...
<?php } else {?>
<meta name="description" content="India Phone Sex | India Chat Lines | Adult Sex Lines">
<meta name="keywords" content="India Phone Sex | India Chat Lines | Adult Sex Lines">
<title>India Phone Sex | India Chat Lines | Adult Sex Lines</title>
<?php } ?>
<!-- InstanceEndEditable -->
