...
$query_RSCats = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 9 ORDER BY cat_name ASC";
...
if (isset($_GET["tbl_id"])) {
  ...
  mysql_select_db($database_Wisdom_Mcr, $Wisdom_Mcr);
  $query_RSCatName = "SELECT * FROM tbl_purebiz_clcats WHERE cat_country = 9 AND tbl_id = ".$_GET["tbl_id"];
