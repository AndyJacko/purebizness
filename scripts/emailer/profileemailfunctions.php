						...
						<tr>
							<td>
								<table width='560' border='0' cellspacing='0' cellpadding='0' align='center'>
									...
									<tr bgcolor='#C2367D'>
										<td align='center' valign='top' height='20' style='padding: 5px; color: #FFFFFF; font-family: Arial; border-top: 2px solid #901b4f; border-bottom: 2px solid #901b4f;'><strong>Comment From Your Purebizness Listing</strong></td>
									</tr>
									<tr>
...
function getFooter() {
	$theFooter = "
			...
			<tr><td>&nbsp;</td></tr>
			<tr><td><p style='font-size: 10px; font-family: Arial;'>Purebizness is not responsible for any interactions you may have with visitors to your listing. All correspondence with listing viewers is at your own risk.</p></td></tr>
		</table>
