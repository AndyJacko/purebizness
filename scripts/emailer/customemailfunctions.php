<?php
function getHeader($title,$reason) {
	$theHeader = "
	<html>
	<body>
		<p style='font-size: 10px; font-family: Arial; font-style: italic;'>NOTE: ".$reason.".</p>
				...
				<tr>
					<td>
						<table width='560' border='0' cellspacing='0' cellpadding='0' align='center'>
							...
							<tr bgcolor='#C2367D'>
								<td align='center' valign='top' height='20' style='padding: 5px; color: #FFFFFF; font-family: Arial; border-top: 2px solid #901b4f; border-bottom: 2px solid #901b4f;'><strong>".$title."</strong></td>
							</tr>
							<tr>
