...
<div id="addwebsite" class="addwebsiteform">
  <form action="/scripts/cp/editprofile/businesssavedetails.php" method="post" name="business">
    ...
    <input type="text" name="Address" id="Address" value="<?php echo $row_RSListing["list_addy"]; ?>" onKeyUp="checkchars('Address',40);" maxlength="40"><span id="AddressChars" class="chars">Characters<br>Remaining: 40</span>
    <div class="clearfix"></div>
    ...
    <input type="text" name="Postcode" id="Postcode" value="<?php echo $row_RSListing["list_postcode"]; ?>">
    <div class="clearfix"></div>
