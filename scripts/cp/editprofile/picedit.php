...
<?php require("../../functions/nav/navfunctions.php"); ?>
<?php session_start(); ?>
<?php
if (isset($_GET["pic"])) {
...
if(strlen($large_photo_exists)>0 && strlen($thumb_photo_exists)>0){
	if(!is_dir("../../../adultdirectories/".getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/")){
		mkdir("../../../adultdirectories/".getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/");
		mkdir("../../../adultdirectories/".getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/m/");
		mkdir("../../../adultdirectories/".getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/t/");
	}
	
	$usrCode = mt_rand() ."". mt_rand();
  $file = "../../../images/".$_SESSION["tmpimgname"]."resized_pic.jpg";
  $newfile = "../../../adultdirectories/".getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/m/".$usrCode.".jpg";
  
  if (!copy($file, $newfile)) {
	  echo "failed to copy $file...\n";
  }
  $file = "../../../images/".$_SESSION["tmpimgname"]."thumbnail_pic.jpg";
  $newfile = "../../../adultdirectories/".getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/t/".$usrCode.".jpg";
  ...
  header("location: /cp/directories/edit.php?s=1&tbl_id=".$_SESSION["id"]);
}
?>
<!DOCTYPE HTML>
...
<body>
  <header id="header"><?php include('../../design/cpheader.php'); ?></header>
  <section id="pagebody">
    <div id="content" class="column">
      ...
      <em>Note: Max image size is 1000px width and will be resized automatically to 200px x 268px - Max image filesize is 1mb</em>.<br>
      ...
      <?php if (!isset($_SESSION["popo"])) { ?>
          <div id="addpic" class="addpicform">
            <form name="photo" enctype="multipart/form-data" action="<?php echo $_SERVER["../PHP_SELF"];?>" method="post">
              ...
              <img src='/adultdirectories/<?php echo getdirectoryurl($row_RSProfile["list_sub"])."/".$row_RSProfile["list_title"]."/t/".$row_RSProfile[$_SESSION["pic"]]; ?>' width='100' class='picborder corners'><br>
              <?php } else { ?>
    ...
    <nav id="sitenav" class="column"><?php require("../../design/cpnav.php"); ?></nav>
    <section id="rhs" class="column">&nbsp;</section>
    <br class="clearfix">
  </section>
  <footer id="footer"><?php require("../../design/footer.php"); ?></footer>
</body>
<!-- InstanceEnd --></html>
<?php 
