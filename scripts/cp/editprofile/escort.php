...
<div id="addwebsite" class="addwebsiteform">
  <form action="/scripts/cp/editprofile/escortsavedetails.php" method="post" name="escort">
    ...
    <?php echo getprices($row_RSListing["list_cost"]); ?>
    <div class="clearfix"></div>
    <label>Call Type<span class="small">Where you work</span></label>
    <?php echo getcall($row_RSListing["list_calltype"]); ?>
    <div class="clearfix"></div>
    ...
    <button type="submit" onClick="return valeditescortform();">UPDATE DETAILS</button>
  </form>
</div>
<script>
checkchars('Phone',20);
