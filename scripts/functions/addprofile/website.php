...
<div id="addwebsite" class="addwebsiteform">
  <form action="/scripts/functions/addprofile/savedetails.php" method="post" name="website">
    <label>Website Name/Title<span class="small">Your website name</span></label>
    ...
    <label>Password<span class="small">Select a password</span></label>
    ...
    <div class="clearfix"></div>
    <input name="listtype" type="hidden" value="1">
    <input name="subid" type="hidden" value="<?php echo $_GET["sub"]; ?>">
    <button type="submit" onClick="return valaddwebsiteform();">ADD PROFILE</button>
  </form>
</div>
<br><br>
