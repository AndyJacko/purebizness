...
<div id="addwebsite" class="addwebsiteform">
  <form action="/scripts/functions/editprofile/escortsavedetails.php" method="post" name="escort">
    ...
    <?php echo getprices($row_RSUser["list_cost"]); ?>
    <div class="clearfix"></div>
    <label>Call Type<span class="small">Where you work</span></label>
    <?php echo getcall($row_RSUser["list_calltype"]); ?>
    <div class="clearfix"></div>
